  ...
  return (
    <div className="container-wrapper flex border-dashed md:border-e">
      ...
      <div className="min-w-0 grow">
        <div className="sticky top-0 z-10 h-16 border-b border-dashed bg-background/90 backdrop-blur-md">
          <div className="h-full pe-4 max-sm:px-4 max-xl:px-6 xl:ps-8 2xl:ps-12">
        ...
        <div className="border-t border-dashed">
          <Footer className="pe-4 max-sm:px-4 max-xl:px-6 xl:ps-8 2xl:ps-12" />
        </div>
      </div>
    </div>
  )
