  ...
  return (
    <div className="group w-64 cursor-pointer">
      <div className="relative">
        ...
        <div
          className={cn(
            'absolute inset-x-1 bottom-1 rounded-md bg-background/50 backdrop-blur-xs transition-all',
            {
        ...
        >
          <div
            className={cn(
              'flex items-start justify-between transition-all duration-500 hover:bg-background/70',
              {
          ...
          >
            <div>
              <p className="mt-1 line-clamp-1 font-medium leading-none transition-all duration-500 max-sm:text-sm">
                Classic White Tee
              </p>
              <p>
                <sup className="text-muted-foreground">$</sup>
                <span className="font-medium text-xl transition-all duration-500">29</span>
              </p>
            </div>
            <div className="mt-1 rounded-full bg-background p-0.5">
              <ChevronDownIcon
                className={cn('size-4 text-muted-foreground transition-all duration-500', {
          ...
          <div ref={contentRef} className="hidden overflow-hidden">
            <div className="p-3 pt-0">
              <div className="flex items-center justify-between">
                <p className="font-medium text-foreground/60 text-sm">Sizes</p>
              ...
              <div className="mt-1 flex items-center gap-1.5">
                ...
                <div className="rounded border bg-foreground/10 px-1 py-px text-sm opacity-60 grayscale-50">
                  Large
                </div>
              </div>
              <div className="mt-3 flex items-center justify-between">
                <p className="font-medium text-foreground/60 text-sm">Colors</p>
              ...
              <div className="mt-3 flex items-end justify-between">
                ...
                <SpringButton
                  scale={0.95}
                  shaking={false}
                  className="flex cursor-pointer items-center gap-2 rounded-md bg-primary px-2.5 py-1.5 font-medium text-primary-foreground text-sm"
                >
        ...
        <div className="-start-18 absolute bottom-2">
          <svg className="-scale-x-100 h-16 rotate-30 fill-foreground/50" viewBox="0 0 511 464">
        ...
        <div className="-start-20 absolute bottom-16">
          <p className="font-medium text-muted-foreground text-sm">Toggle</p>
        </div>
      </div>
    </div>
  )
